...
### Task: Integrate trusted verifier compatibility into the preview branch
Date: 2026/09/19 12:46

- Resolved the smoke script conflict using the reviewed master implementation that supports both log layouts.
- Preserved both branches' journal entries.

**Result**: Feature branch contains the master verifier fix and its regression coverage; production MCP behavior is unchanged.
...
### Preview installer: integrate trusted controller
Date: 2026/09/20 12:46
...
### Integrate verified installer lifecycle correction
Date: 2026/09/20 14:31
