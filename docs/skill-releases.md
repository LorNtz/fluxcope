...
5. Push that tag and install from its public URL into a fresh temporary project:
   ...
   DISABLE_TELEMETRY=1 npx skills@1.7.0 add \
     https://github.com/LorNtz/fluxcope/tree/skill-vVERSION/skills/fluxcope-mcp \
