...
mod prefilter;
use prefilter::{PrefilterTableWidget, prefilter_table_widget};
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(super) struct SettingsFieldLayout {
    selected_prefix: &'static str,
    idle_prefix: &'static str,
    prefix_width: u16,
    label_width: u16,
...
impl SettingsFieldLayout {
    ...
    pub(super) fn areas(self, area: Rect) -> SettingsFieldRowAreas {
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(super) struct SettingsFieldRowAreas {
    prefix: Rect,
    label: Rect,
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(super) struct SettingsSelectLayout {
    target: SelectTarget,
    pub(super) layout: crate::select_widget::SelectWidgetLayout,
}
...
pub(super) struct SettingsFieldRow<'a> {
    label: Cow<'a, str>,
    selected: bool,
...
pub(super) enum SettingsFullWidthTable<'a> {
...
pub(super) enum SettingsContentItem<'a> {
    Line(Line<'static>),
    Divider {
        title: &'static str,
    },
...
impl SettingsContentItem<'_> {
    pub(super) fn height(&self, layout: SettingsFieldLayout, width: u16) -> u16 {
        match self {
            Self::Line(_) => 1,
...
pub(super) fn settings_content_items_with_error<'a>(
...
pub(super) fn settings_field_layout(items: &[SettingsContentItem<'_>]) -> SettingsFieldLayout {
...
pub(super) fn settings_content_height(
    items: &[SettingsContentItem<'_>],
    min_height: u16,
    layout: SettingsFieldLayout,
    content_width: u16,
...
pub(super) fn settings_select_layout(
    items: &[SettingsContentItem<'_>],
    target: Option<SelectTarget>,
    layout: SettingsFieldLayout,
    content_width: u16,
...
pub(super) const SETTING_TEXT_FIELD_HEIGHT: u16 = 3;
// Border columns plus the explicit leading/trailing spaces in the rendered textarea text.
pub(super) const TEXT_INPUT_CHROME_WIDTH: u16 = 4;
pub(super) const PORT_INPUT_WIDTH_COLS: u16 = 10;
pub(super) const PEM_FILENAME_INPUT_WIDTH_COLS: u16 = 32;
...
pub(super) struct SettingsTextInputControl<'a> {
    pub(super) value: Cow<'a, str>,
    pub(super) cursor: Option<usize>,
    pub(super) fixed_edit_width_cols: Option<u16>,
    pub(super) hint: Option<&'a str>,
}

impl SettingsTextInputControl<'_> {
    pub(super) fn render_width(&self, available_width: u16) -> u16 {
...
pub(super) fn settings_select_control<'a>(
    popup: &'a SettingsPopup,
    target: SelectTarget,
...
pub(super) struct SettingsSelectControl<'a> {
    target: SelectTarget,
...
pub(super) struct ProxyRuleTableWidget<'a> {
...
pub(super) fn proxy_rule_table_widget<'a>(
    popup: &SettingsPopup,
    table: ProxyRuleTable,
...
pub(super) fn rule_editor_area(parent: Rect) -> Rect {
...
pub(super) fn action_dialog_area(dialog: &ActionDialog, parent: Rect) -> Rect {
